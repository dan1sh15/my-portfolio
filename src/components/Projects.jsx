...
const Projects = ({darkMode}) => {
  ...
  return (
    <div
        ...
        <p className={`poppins text-center max-md:text-[1.25rem] text-[2rem] ${darkMode ? "text-lightContent" : "text-darkContent"} font-medium`}>Things I've built so far</p>

        <div className= ' mt-10 grid grid-cols-3 gap-10 max-ipad:gap-x-5 max-ipad:grid-cols-2 max-sm:grid-cols-1 justify-center items-center max-md:gap-6'>
            {
