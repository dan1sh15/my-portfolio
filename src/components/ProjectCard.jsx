...
const ProjectCard = (props) => {
  ...
  return (
    <div className={`flex gap-3 flex-col ${darkMode ? "bg-[#363636]" : "bg-[#fff]"} items-center max-phone:w-[90%] max-md:w-[45%] w-[30%] mb-7 rounded-xl ${darkMode ? "noShadow" : "customShadow"} hover:scale-[1.04] transition-all duration-300 ease-in-out`}>
